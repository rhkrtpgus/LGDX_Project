...
export const YOUTUBE_CATEGORY_OPTIONS: YoutubeCategoryOption[] = [
  {
    ...
    label: '영화·애니메이션',
    shortLabel: '애니',
    description: '애니메이션, 영화, 이야기형 영상',
    accent: '#9b7fe8',
    aliases: ['영화', '애니메이션', '애니', 'film', 'animation'],
  },
  {
    id: 'autos_vehicles',
    label: '자동차·이동수단',
    shortLabel: '탈것',
    description: '자동차, 기차, 탈것 중심 영상',
    accent: '#7aa6ff',
    aliases: ['자동차', '차량', '탈것', 'vehicles', 'autos'],
  },
  {
    id: 'music',
    label: '음악',
  ...
  },
  {
    ...
    label: '스포츠',
    shortLabel: '스포츠',
    description: '운동, 경기, 스포츠 체험 영상',
    accent: '#ff7a7a',
    aliases: ['스포츠', '운동', 'sports'],
  },
  {
    id: 'travel_events',
    label: '여행·이벤트',
    ...
    accent: '#f4b860',
    aliases: ['여행', '이벤트', '체험', 'travel', 'events'],
  },
  {
    id: 'gaming',
    label: '게임',
  ...
  },
  {
    ...
    label: '인물·브이로그',
    shortLabel: '일상',
    description: '일상, 가족 브이로그, 인물 이야기 영상',
    accent: '#7dc67e',
    aliases: ['인물', '브이로그', '일상', 'people', 'blogs'],
  },
  {
    id: 'comedy',
    label: '코미디',
  ...
  },
  {
    ...
    accent: '#d08fdc',
    aliases: ['생활', '스타일', '만들기', 'howto', 'style'],
  },
  {
    id: 'education',
    label: '교육',
  ...
  },
  {
    ...
    accent: '#58b7a5',
    aliases: ['비영리', '사회활동', '사회', 'activism', 'nonprofits'],
  },
]
...
export const YOUTUBE_QUICK_PICKS: YoutubeQuickPick[] = [
  {
    ...
    subtitle: '부드러운 이야기형 영상',
    description: '시각 자극이 강하지 않은 화면 위주로 먼저 확인하기 좋은 카드예요.',
  ...
  },
  {
    ...
    subtitle: '기초 원리와 기술을 다뤄보는 짧은 영상',
    description: '호기심이 많은 아이가 원리 중심으로 보기 좋게 고른 카드예요.',
  ...
  },
  {
    ...
    description: '조용하게 보고 다음 이야기로 이어가기 좋은 일상형 콘텐츠예요.',
  ...
  },
  {
    ...
    subtitle: '동요와 음악 취향을 확인하기 좋은 카드',
    description: '집중이 필요한 시간보다 쉬는 시간에 먼저 틀어보기 좋아요.',
    categoryId: 'music',
    durationLabel: '3분',
    badge: '음악형',
  ...
  },
  {
    ...
    description: '빠른 편집보다 관찰 중심 영상으로 먼저 확인하기 좋게 넣었어요.',
